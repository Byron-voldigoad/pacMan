...
export function drawGhost(ctx) {
  ...
  const xRose =
    possitionFantomeRose.col * cellSize + (cellSize - ghostWidth) / 2; // Position X du fantôme rose
  const yRose =
    possitionFantomeRose.row * cellSize + (cellSize - ghostHeight) / 2; // Position Y du fantôme rose

  const xBleu =
    possitionFantomeBleu.col * cellSize + (cellSize - ghostWidth) / 2; // Position X du fantôme bleu
  const yBleu =
    possitionFantomeBleu.row * cellSize + (cellSize - ghostHeight) / 2; // Position Y du fantôme bleu

  const xOrange =
    possitionFantomeOrange.col * cellSize + (cellSize - ghostWidth) / 2; // Position X du fantôme orange
  const yOrange =
    possitionFantomeOrange.row * cellSize + (cellSize - ghostHeight) / 2; // Position Y du fantôme orange
...
export function redrawGame(ctx) {
  ...
  const xRose =
    possitionFantomeRose.col * cellSize + (cellSize - ghostWidth) / 2;
  const yRose =
    possitionFantomeRose.row * cellSize + (cellSize - ghostHeight) / 2;

  const xBleu =
    possitionFantomeBleu.col * cellSize + (cellSize - ghostWidth) / 2;
  const yBleu =
    possitionFantomeBleu.row * cellSize + (cellSize - ghostHeight) / 2;

  const xOrange =
    possitionFantomeOrange.col * cellSize + (cellSize - ghostWidth) / 2;
  const yOrange =
    possitionFantomeOrange.row * cellSize + (cellSize - ghostHeight) / 2;
...
export const ghostPosition = [
  possitionFantomeRouge,
  possitionFantomeRose,
  possitionFantomeBleu,
  possitionFantomeOrange,
];
