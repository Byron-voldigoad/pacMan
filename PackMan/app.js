...
let menuMusic = new Audio(
  "../assets/audio/DAN_DA_DAN_Opening___Otonoke_by_Creepy_Nuts(256k).mp3"
); // Musique du menu
let waitMusic = new Audio(
  "../assets/audio/Creepy_nuts_-_Otonoke__Dandadan_Op__Ringtone(256k).mp3"
); // Musique d'attente
let gameMusic = new Audio(
  "../assets/audio/Naruto_Shippuden_OST_1_-_Track_02_-_Douten_(_Heaven_Shaking_Event_)(256k).mp3"
); // Musique du jeu
...
export function stopGameMusic() {
  gameMusic.pause();
  gameMusic.currentTime = 0; // Rewind à zéro
}
